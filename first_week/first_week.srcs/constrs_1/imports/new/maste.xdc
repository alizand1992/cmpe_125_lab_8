...
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports {clk}]; # Right Button
#set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {BTND}]; # Down Button

## Switches
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {in1[0]}];  # Switch 0
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {in1[1]}];  # Switch 1
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports {in1[2]}];  # Switch 2
set_property -dict {PACKAGE_PIN W17 IOSTANDARD LVCMOS33} [get_ports {in1[3]}];  # Switch 3
#set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {SW[4]}];  # Switch 4
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {in2[0]}];  # Switch 5
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {in2[1]}];  # Switch 6
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports {in2[2]}];  # Switch 7
set_property -dict {PACKAGE_PIN V2  IOSTANDARD LVCMOS33} [get_ports {in2[3]}];  # Switch 8
...
#set_property -dict {PACKAGE_PIN W2  IOSTANDARD LVCMOS33} [get_ports {go}]; # Switch 12
#set_property -dict {PACKAGE_PIN U1  IOSTANDARD LVCMOS33} [get_ports {SW[13]}]; # Switch 13
#set_property -dict {PACKAGE_PIN T1  IOSTANDARD LVCMOS33} [get_ports {op[0]}]; # Switch 14
set_property -dict {PACKAGE_PIN R2  IOSTANDARD LVCMOS33} [get_ports {go_sw}]; # Switch 15

## LEDs
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {err}];  # LED 0
#set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports {done}];  # LED 1
